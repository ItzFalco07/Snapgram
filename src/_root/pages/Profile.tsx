...
const Profile = () => {
  ...
  useEffect(() => {
    if (currentUser && currentUser.name === "Rupam_Das" || currentUser && currentUser.name === "RupamDas") {
  ...
  if (isLoading || !currentUser) // Added isLoading check
    return (
        ...
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          ...
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            <div className="flex flex-col w-full ">
              <h1 className="fixLayout xl:text-left h3-bold md:h1-semibold w-full flex">
                {currentUser.name}
                {currentUser.name === "Rupam_Das" && (
                  <span id="tick" className="w-[46px] h-[13px]"></span>
                )}
              </h1>
            ...
            <div className="flex gap-8 mt-10 items-center justify-center xl:justify-start flex-wrap z-20">
              ...
              <StatBlock value="10k" label="Followers" />
              <StatBlock value="28k" label="Following" />
            </div>
